<template>
  <div class="modal-cancelar-cita">
    ...
    <button type="button" class="btn btn-danger border border-2 rounded-circle" data-bs-toggle="modal" data-bs-target="#cancelarCita" title="Cancelar cita" @click="cancelacionCita">
