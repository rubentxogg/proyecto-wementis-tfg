<template>
  <div class="modal-completar-cita">
    ...
    <button type="button" class="btn btn-success border border-2" data-bs-toggle="modal" data-bs-target="#completarCita" title="Completar cita" @click="completacionCita">
