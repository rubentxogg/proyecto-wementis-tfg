<template>
  <div class="modal-delete-paciente">
    ...
    <button type="button" class="btn btn-danger rounded-circle border border-2" data-bs-toggle="modal" data-bs-target="#deletePaciente" title="Borrar paciente" @click="borradoPaciente">
